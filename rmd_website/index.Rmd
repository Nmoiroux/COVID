...
author: 'Nicolas Moiroux and Paul Taconet (MIVEGEC, Univ. Montpellier, CNRS, IRD)'
...
```
This work is for an academic purpose and should not constitute a decision making support. We used a model that is simple in its structure and its assumptions. The results do not necessarly reflect the reality. Its purpose is to illustrate how social structure and age distribution might affect the dynamic and public health consequences of an outbreak.
\
\
...
Age distribution of France is almost stationary indicating equal birth and death rates. The mean number of daily contact is `r round(av_d_ctc[[2]], 1)` c.d$^{-1}$ mostly with individual of the same age. There is little differences of daily number of contacts among age classes.  
