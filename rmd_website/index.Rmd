---
title: "An age-structured SIR model of COVID19 to study the impact of age structure and intercations on the spread of the disease in 146 countries"
author: "Nicolas Moiroux, Paul Taconet"
date: "28/03/2020"
...
df <- prev %>% gather(1:3, key=Country, value=prev)
p <- ggplot(df,aes(x = days, y = prev,  group = Country, color = Country)) +
	geom_line()
...
df2 <- recov %>% gather(1:3, key=Country, value=recov)
p2 <-	ggplot(df2,aes(x = days, y = recov,  group = Country, color = Country)) +
	geom_line()
